...
![Customer & Accounts](screenshots/customer%20%26%20accounts.png)

### Transactions & Merchants
Channel mix, top merchant categories, flagged high-value transactions
![Transactions & Merchants](screenshots/transactions%20and%20merchants.png)

### Loans & Cards
Loan book by type, delinquency rate by city, card type distribution
![Loans & Cards](screenshots/loans%20%26%20cards.png)

### Branch Performance
Branch-wise balance and loan book, customer/loan density per branch
![Branch Performance](screenshots/branch%20performance.png)
...
│   ├── transactions and merchants.png
│   ├── loans & cards.png
