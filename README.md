...
![Transactions & Merchants](screenshots/transactions-merchants.png)

### Loans & Cards
Loan book by type, delinquency rate by city, card type distribution
![Loans & Cards](screenshots/loans-cards.png)

### Branch Performance
Branch-wise balance and loan book, customer/loan density per branch
![Branch Performance](screenshots/branch-performance.png)
